...
To use these stylesheets, rename the files and zigzagdish with the name of your theme.
...
zigzagdish-alpha-default-narrow.css  
...
zigzagdish-alpha-default-normal.css
...
zigzagdish-alpha-default-wide.css
